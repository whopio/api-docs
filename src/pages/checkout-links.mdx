...
If you’d like users to get automatically redirected to a different website after their purchase is successful, you can add an `onSuccess` parameter to the end of your checkout URL such as `https://whop.com/checkout/plan_xxxxx?onSuccess=https://apple.com` to redirect to Apple after purchase. Alternatively, you can set it up by following the below:
