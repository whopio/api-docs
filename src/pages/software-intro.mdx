...
This guide assumes that you have already [created your company](https://docs.whop.com/creating-company) and are building a software application that you want to sell.
...
Note: Alternatively, we have a simpler integration that involves a license key form of authenticating users. See [here](https://dev.whop.com/reference/validate_license)
...
2. Under the "What's included" section, add Web App
3. Enter a title that your customers will see as well as the callback URL from the earlier step.
