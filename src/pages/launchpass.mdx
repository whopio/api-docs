...
3. Once we have collected the required data please **kick the Launchpass bot** from your server so we can remove Launchpass’s fees and finalize your customers subscriptions. We will let you know when to do this.
