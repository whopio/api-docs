...
Once you have connect your Discord, there is nothing left for you to do on the Dashboard. Simply head over to your Stripe ‘**[Team member](https://dashboard.stripe.com/settings/team)**’ settings and add **hello@whop.com** as an administrator to your Stripe account. 
...
2. Upon our team joining your server, grant them access to the #launchpass channel. This will enable us to gather all of the relevant data we need to import all of your users without anyone dropping off!

You can track the progress of us migrating your members and subscriptions on your **Members** page.

1. Once we have collected the required data please **kick the Launchpass bot** from your server so we can remove Launchpass’s fees and finalize your members subscriptions. We will let you know when to do this.
2. Important - Announce the transfer to your community and shut down the other dashboard to avoid any confusion.

## Results

Without any downtime, the customer subscriptions you previous had on Launchpass will have been moved to Whop and your customers wouldn’t find anything has changed besides the platform they use to login to, to manage their membership. 
