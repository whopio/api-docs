...
For the main form of payment on Whop - Card payments, there are two different fee structures available. The fees are broken down by whether or not Whop acts as the [Merchant of Record (MoR)](/merchant-of-record) for your business or not. If you have not heard of MoR you can skip this part, as MoR is only beneficial for countries that have VAT taxes (EU & UK).
...
3. For [crypto payments](/crypto) on Whop we take a flat 1% fee across the board. Whether you take direct ETH payments or use Coinbase commerce we will only take a 1% fee. 
