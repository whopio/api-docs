...
![Raffle Header](https://i.imgur.com/8R3cITY.png){{ className: 'rounded-lg w-full' }}
...
- View Pass - View the pass in which the raffle was created under
...
- Send Webhook - Sends a enter raffle webhook to the raffle webhook channel set within the Whop Dash [Discord settings](https://dash.whop.com/settings/discord) page
