...
export const image = 'https://i.imgur.com/kDE5cWn.png'
...
![Crypto Payments Header](https://i.imgur.com/kDE5cWn.png){{ className: 'rounded-lg w-full' }}
...
A breakdown of associated fees can be found [here](/fees).
...
Once your funds have been converted, to access your funds for withdrawal-able balance, navigate to **[Whop.com](http://Whop.com),** select **Account settings**, go to **Your Balance**, select **Withdraw** and fill in the respective fields to receive your funds.
